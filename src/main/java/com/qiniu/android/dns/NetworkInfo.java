...
public final class NetworkInfo {
    ...
    public static final NetworkInfo noNetwork =
            new NetworkInfo(NetSatus.NO_NETWORK, ISP_GENERAL, null);
    public static final NetworkInfo normal =
            new NetworkInfo(NetSatus.WIFI, ISP_GENERAL, null);
    /**
     * 运营商
     */
     ...
     * DNS
     */
    public List<InetAddress> dnsServers;

    public NetworkInfo(NetSatus status, int provider, List<InetAddress> dnsServers) {
